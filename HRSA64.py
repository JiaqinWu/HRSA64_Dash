...
GU-TAP System
                ...
                with st.expander("🧳 **Generate Domestic Travel Authorization Form (Under Development Now, DO NOT USE)**"):
                    st.markdown("""
                        <div style='background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 20px; box-shadow: 0 8px 32px rgba(102, 126, 234, 0.3); padding: 2em 1.5em 1.5em 1.5em; margin-bottom: 2em; margin-top: 1em;'>
                            <div style='color: white; font-family: "Segoe UI", "Arial", sans-serif; font-weight: 800; font-size: 1.6em; margin-bottom: 0.5em; text-align: center;'>
                            ...
                            if generate_now and approved:
                                ...
                                try:
                                    ...
                                    if row_idx >= 0 and row_idx < len(df_travel):
                                        ...
                                        mabintou_email = "nathaniel.wong@georgetown.edu"
...
GU-TAP System
                                        ...
                                        try:
                                            ...
                                            email_messages.append(f"✅ Email sent successfully to {kemisha_name} ({kemisha_email})")
                                        except Exception as e:
                                            email_messages.append(f"⚠️ Failed to send email to {kemisha_name}: {str(e)}")
                                        ...
                                        try:
                                            ...
                                            email_success_count += 1
                                            email_messages.append(f"✅ Email sent successfully to {mabintou_name} ({mabintou_email})")
                                        except Exception as e:
                                            email_messages.append(f"⚠️ Failed to send email to {mabintou_name}: {str(e)}")
